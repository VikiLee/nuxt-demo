 ...
 * @param {*} url 要打开的地址 
 */
export function windowOpen(url, target = '_self') {
...
export function isMobile(mobile) {
  return /^0?1[3|4|5|8][0-9]\d{8}$/.test(mobile)
}
...
/**
 * 切断多于指定长度的字符串，包含中文，1个中文=2个英文
 * @param {*} str 源字符串
 * @param {*} len 长度
 * @param {*} append 拼接在后面的字符，如"asdsadsad...
 */
export function cutstr(str, len, append = '') {
  var str_length = 0
  var str_len = 0
